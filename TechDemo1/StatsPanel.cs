...
namespace TechDemo1
{
    class StatsPanel : SadConsole.Consoles.Console
    {
        private string characterName;
        private int health;
        private int maxHealth;

        public StatsPanel(int width, int height) : base(width, height)
        {
            // Draw the side bar
        ...
        public StatsPanel(String name, int width, int height) : this(width, height)
        {
            CharacterName = name;
            // Draw the side bar
            SadConsole.Shapes.Line line = new SadConsole.Shapes.Line();
